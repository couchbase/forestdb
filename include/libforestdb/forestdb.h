 ...
 * set to FDB_COMPACTION_AUTO, but instead the name of a new compacted file will be
 * automatically generated by increasing its current file revision number.
 ...
 * If the mode is changed to FDB_COMPACTION_AUTO, the compaction threshold is set to
 * the threshold passed to this API.
 * This API can be also used to change the compaction threshould for a given database
 * file whose compaction mode is currently FDB_COMPACTION_AUTO.
 *
