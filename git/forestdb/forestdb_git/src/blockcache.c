...
struct fnamedic_item *_bcache_get_victim()
{
    ...
    if (e==NULL) {
        ...
        while (e) {
            ...
            if (!(fname->cleanlist.head == NULL && fname->rbtree.rb_node == NULL)) {
                break;
            }
            e = list_next(e);
        }
